...
class GetEndpointEntity
  ...
  def make
    opts = @_entopts.dup
    GetEndpointEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [GetEndpointListMatch, Hash, nil] match filter (any subset of
  #   GetEndpoint fields); defaults to nil, treated as an empty match that lists all.
