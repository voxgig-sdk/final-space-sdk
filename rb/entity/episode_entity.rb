...
class EpisodeEntity
  ...
  # @return [Episode, Hash] the loaded Episode; raises FinalSpaceError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Episode>, Array] the matching Episode items; raises FinalSpaceError on failure
