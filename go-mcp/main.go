// Command FinalSpace-mcp is an MCP server exposing the FinalSpace
// SDK as MCP tools.
//
// Two tools are registered:
//
//	FinalSpace_list  — list records of an entity
//	FinalSpace_load  — load a single record of an entity
//
