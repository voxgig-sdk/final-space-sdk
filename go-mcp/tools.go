...
type Args struct {
	Entity string         `json:"entity" jsonschema:"character | episode | get_endpoint | location | quote"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FinalSpaceSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "final-space_list",
		Description: "List records from FinalSpace. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "final-space_load",
		Description: "Load a single record from FinalSpace. " +
...
func runOp(client *sdk.FinalSpaceSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FinalSpaceSDK, name string) (sdk.FinalSpaceEntity, error) {
	...
	case "get_endpoint":
		return client.GetEndpoint(nil), nil
	case "location":
