...
// FinalSpace SDK telemetry feature
...
class FinalSpaceTelemetryFeature extends FinalSpaceBaseFeature
{
    ...
    private function _close(FinalSpaceContext $ctx, bool $ok): void
    {
