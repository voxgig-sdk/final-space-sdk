...
class FinalSpaceRbacFeature extends FinalSpaceBaseFeature
{
    ...
    private function _required(FinalSpaceContext $ctx): ?string
    {
    ...
    private function _reject(FinalSpaceContext $ctx, string $required): void
    {
    ...
    private function _track(FinalSpaceContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
