...
// FinalSpace SDK idempotency feature
...
class FinalSpaceIdempotencyFeature extends FinalSpaceBaseFeature
{
    ...
    private function _mutating(FinalSpaceContext $ctx): bool
    {
