...
// FinalSpace SDK timeout feature
...
class FinalSpaceTimeoutFeature extends FinalSpaceBaseFeature
{
    ...
    private function _with_timeout(FinalSpaceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FinalSpaceContext $_ctx, float $ms): void
    {
        $client = $this->client;
