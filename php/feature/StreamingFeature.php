...
// FinalSpace SDK streaming feature
...
class FinalSpaceStreamingFeature extends FinalSpaceBaseFeature
{
    ...
    private function _iterate(FinalSpaceResult $result): \Generator
    {
    ...
    private function _streamable(FinalSpaceContext $ctx): bool
    {
