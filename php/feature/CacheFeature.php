...
class FinalSpaceCacheFeature extends FinalSpaceBaseFeature
{
    ...
    private function _through(FinalSpaceContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
