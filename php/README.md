...
The PHP SDK for the FinalSpace API — an entity-oriented client using PHP conventions.
...
```php
// list() returns an array of GetEndpoint records (throws on error).
...
```
php/
├── finalspace_sdk.php          -- Main SDK class
...
The main class (`finalspace_sdk.php`) exports the SDK class
