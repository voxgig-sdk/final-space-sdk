...
// FinalSpace SDK utility: fetcher

class FinalSpaceFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FinalSpaceSDK/1.0)';
    ...
    public static function call(FinalSpaceContext $ctx, string $fullurl, array $fetchdef): array
    {
