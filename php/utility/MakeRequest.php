...
// FinalSpace SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FinalSpaceMakeRequest
{
    public static function call(FinalSpaceContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FinalSpaceResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FinalSpaceResponse($fetched);
        } else {
