...
// FinalSpace SDK utility: graphql
//
...
class FinalSpaceGraphql
{
    ...
    // equivalent.
    public static function body(FinalSpaceContext $ctx): mixed
    {
    ...
    public static function errors(FinalSpaceContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
