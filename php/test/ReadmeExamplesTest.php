...
// FinalSpace SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FinalSpaceSDK::test)
...
{
    private const SDK_CLASS = 'FinalSpaceSDK';
    ...
    private const SDK_BASE = 'finalspace_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../finalspace_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
