...
class FinalSpaceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FinalSpaceTestRunner.getenv("FINALSPACE_TEST_LIVE")
        override = FinalSpaceTestRunner.getenv("FINALSPACE_TEST_OVERRIDE")
        ...
        explain = FinalSpaceTestRunner.getenv("FINALSPACE_TEST_EXPLAIN")
