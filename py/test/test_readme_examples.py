# FinalSpace SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FinalSpaceSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FinalSpaceSDK(...) and FinalSpaceSDK.test(...) become
#      FinalSpaceSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "finalspace_sdk"
_SDK_CLASS = "FinalSpaceSDK"
