...
from core.utility_type import FinalSpaceUtility
...
class FinalSpaceSDK:
    ...
    def get_endpoint(self):
        ...
        cached = getattr(self, "_get_endpoint", None)
        if cached is None:
            cached = GetEndpointEntity(self, None)
            self._get_endpoint = cached
        return cached

    def GetEndpoint(self, data=None):
