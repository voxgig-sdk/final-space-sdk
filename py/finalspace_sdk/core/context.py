...
from finalspace_sdk.core.helpers import get_ctx_prop, to_map
...
class FinalSpaceContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, FinalSpaceSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, FinalSpaceResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FinalSpaceResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FinalSpaceError(code, msg, self)
