...
from finalspace_sdk.utility import register

# Load features
from finalspace_sdk.feature.base_feature import FinalSpaceBaseFeature
from finalspace_sdk.features import _has_feature, _make_feature
...
class FinalSpaceSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = FinalSpaceUtility()
        self._utility = utility

        from finalspace_sdk.config import shared_config
    ...
    def get_utility(self):
        return FinalSpaceUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FinalSpaceSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from finalspace_sdk.entity.character_entity import CharacterEntity
    ...
    def Episode(self, data=None) -> "EpisodeEntity":
        ...
        from finalspace_sdk.entity.episode_entity import EpisodeEntity
    ...
    def GetEndpoint(self, data=None) -> "GetEndpointEntity":
        ...
        from finalspace_sdk.entity.get_endpoint_entity import GetEndpointEntity
    ...
    def Location(self, data=None) -> "LocationEntity":
        ...
        from finalspace_sdk.entity.location_entity import LocationEntity
        return LocationEntity(self, data)


    def Quote(self, data=None) -> "QuoteEntity":
        """Entity factory: client.Quote().list() / client.Quote().load({"id": ...})."""
        from finalspace_sdk.entity.quote_entity import QuoteEntity
        return QuoteEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "FinalSpaceSDK":
        if sdkopts is None:
            sdkopts = {}
