...
from finalspace_sdk.finalspace_types import (
    GetEndpoint,
...
class GetEndpointEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetEndpointEntity(self._client, opts)
    ...
    def match_get(self) -> GetEndpoint:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GetEndpoint]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GetEndpoint().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
