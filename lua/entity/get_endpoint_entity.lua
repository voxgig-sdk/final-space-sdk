...
local GetEndpointEntity = {}
GetEndpointEntity.__index = GetEndpointEntity


function GetEndpointEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetEndpointEntity)
  self._name = "get_endpoint"
  self._client = client
...
function GetEndpointEntity:get_name()
  return self._name
end


function GetEndpointEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetEndpointEntity.new(self._client, opts)
end
...
function GetEndpointEntity:mark_deleted()
  self._deleted = true
end


function GetEndpointEntity:deleted()
  return true == self._deleted
end


function GetEndpointEntity:data_set(args)
  if args ~= nil then
...
function GetEndpointEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetEndpointEntity:match_set(args)
  if args ~= nil then
...
function GetEndpointEntity:match_get()
...
function GetEndpointEntity:stream(action, args, callopts)
...
function GetEndpointEntity:_run_op(ctx, post_done)
  local utility = self._utility
