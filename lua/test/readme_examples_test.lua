...
local SDK_MODULE = "final-space_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["character"] = { ["test01"] = { id = "test01" } }, ["episode"] = { ["test01"] = { id = "test01" } }, ["get_endpoint"] = { ["test01"] = { id = "test01" } }, ["location"] = { ["test01"] = { id = "test01" } }, ["quote"] = { ["test01"] = { id = "test01" } } } }'
