...
describe("GetEndpointDirect", function()
  it("should direct-list-get_endpoint", function()
    local setup = get_endpoint_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-get_endpoint", setup.live and "live" or "unit")
...
function get_endpoint_direct_setup(mockres)
