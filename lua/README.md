...
The Lua SDK for the FinalSpace API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/final-space-sdk/releases)),
...
Create an instance: `local get_endpoint = client:GetEndpoint(nil)`
...
```lua
local get_endpoints, err = client:GetEndpoint():list()
```
...
```
lua/
├── final-space_sdk.lua    -- Main SDK module
...
The main module (`final-space_sdk`) exports the SDK constructor
