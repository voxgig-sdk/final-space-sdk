...
An API based on the animated television show Final Space, providing data such as character info obtained from the Final Space wiki.

Learn more about Final Space API at [finalspaceapi.com/docs](https://finalspaceapi.com/docs/).
...
This SDK exposes the API as a small set of **semantic entities** — Character, Episode, GetEndpoint, Location and Quote — that you
...
| **GetEndpoint** | The GetEndpoint entity (list). | `/` |
| **Location** | The Location entity (list, load). | `/location` |
| **Quote** | The Quote entity (list). | `/quote` |
