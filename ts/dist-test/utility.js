...
function envOverride(m) {
    if ('TRUE' === process.env.FINAL_SPACE_TEST_LIVE ||
        'TRUE' === process.env.FINAL_SPACE_TEST_OVERRIDE) {
    ...
    m.FINAL_SPACE_TEST_EXPLAIN = process.env.FINAL_SPACE_TEST_EXPLAIN || m.FINAL_SPACE_TEST_EXPLAIN;
    return m;
}
