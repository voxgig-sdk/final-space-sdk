...
(0, node_test_1.describe)('GetEndpointDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.FinalSpaceSDK({
    ...
    (0, node_test_1.test)('direct-list-get_endpoint', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-get_endpoint', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.FINAL_SPACE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.FinalSpaceSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['FINAL_SPACE_TEST_GET_ENDPOINT_ENTID'];
    ...
    const client = new __1.FinalSpaceSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetEndpointDirect.test.js.map