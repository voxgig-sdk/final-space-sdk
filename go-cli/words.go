...
func registerSDKWords(r *eng.Registry, client *sdk.FinalSpaceSDK) {
...
func runOp(client *sdk.FinalSpaceSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
