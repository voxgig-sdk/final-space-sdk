...
AQL-driven CLI and REPL for the FinalSpace SDK. Positional arguments are
...
./final-space-cli load 1 character
./final-space-cli load '{id:1}' character
