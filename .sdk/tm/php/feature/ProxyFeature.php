...
class FinalSpaceProxyFeature extends FinalSpaceBaseFeature
{
    ...
    public function init(FinalSpaceContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FinalSpaceContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
