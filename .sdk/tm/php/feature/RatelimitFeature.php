...
// FinalSpace SDK ratelimit feature
...
class FinalSpaceRatelimitFeature extends FinalSpaceBaseFeature
{
    ...
    private function _acquire(FinalSpaceContext $ctx): void
    {
    ...
    private function _track(FinalSpaceContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
