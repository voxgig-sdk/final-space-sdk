...
// FinalSpace SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FinalSpaceTestFeature extends FinalSpaceBaseFeature
{
    ...
    public function init(FinalSpaceContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FinalSpaceContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = FinalSpaceParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FinalSpaceContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FinalSpaceContext $ctx, $op, $args): array
    {
