...
// FinalSpace SDK clienttrack feature
...
class FinalSpaceClienttrackFeature extends FinalSpaceBaseFeature
{
    ...
    public function PostConstruct(FinalSpaceContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FinalSpace-SDK';
