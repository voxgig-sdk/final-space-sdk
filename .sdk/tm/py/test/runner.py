...
class FinalSpaceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FinalSpaceTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = FinalSpaceTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = FinalSpaceTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
