...
class FinalSpaceTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FinalSpaceTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FinalSpaceTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FinalSpaceTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
