...
|---|---|---|
| `ts/` | @voxgig-sdk/final-space-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/final-space-sdk \
      --repository voxgig-sdk/final-space-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/final-space-sdk` shows it, and
`npm trust revoke @voxgig-sdk/final-space-sdk --id=<id>` removes it.
