...
const testSeed = `map[string]any{"entity": map[string]any{"character": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "episode": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_endpoint": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "location": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "quote": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
