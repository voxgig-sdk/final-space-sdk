# FinalSpace Golang SDK



The Golang SDK for the FinalSpace API — an entity-oriented client using standard Go conventions. No generics required; data flows as `map[string]any`.
...
## Install
```bash
go get github.com/voxgig-sdk/final-space-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/final-space-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/final-space-sdk/go=../final-space-sdk/go
```
...
```go
func TestSDK(testopts map[string]any, sdkopts map[string]any) *FinalSpaceSDK
```

Creates a test-mode client with mock transport. Both arguments may be `nil`.

### FinalSpaceSDK methods
...
| `Character` | `(data map[string]any) FinalSpaceEntity` | Create a Character entity instance. |
| `Episode` | `(data map[string]any) FinalSpaceEntity` | Create an Episode entity instance. |
| `GetEndpoint` | `(data map[string]any) FinalSpaceEntity` | Create a GetEndpoint entity instance. |
| `Location` | `(data map[string]any) FinalSpaceEntity` | Create a Location entity instance. |
| `Quote` | `(data map[string]any) FinalSpaceEntity` | Create a Quote entity instance. |

### Entity interface (FinalSpaceEntity)

All entities implement the `FinalSpaceEntity` interface.
...
```
github.com/voxgig-sdk/final-space-sdk/go/
├── final-space.go        # Root package — type aliases and constructors
...
The root package (`github.com/voxgig-sdk/final-space-sdk/go`) re-exports everything needed
