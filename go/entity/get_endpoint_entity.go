...
type GetEndpointEntity struct {
	name    string
	client  *core.FinalSpaceSDK
...
func NewGetEndpointEntity(client *core.FinalSpaceSDK, entopts map[string]any) *GetEndpointEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetEndpointEntity) GetName() string { return e.name }
...
func (e *GetEndpointEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetEndpointEntity) Deleted() bool {
	return e.deleted
}


func (e *GetEndpointEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetEndpointEntity(e.client, opts)
}

func (e *GetEndpointEntity) Data(args ...any) any {
...
func (e *GetEndpointEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetEndpoint; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetEndpointEntity) DataTyped(data ...GetEndpoint) GetEndpoint {
	if len(data) > 0 {
		return typedFrom[GetEndpoint](e.Data(asMap(data[0])))
	}
	return typedFrom[GetEndpoint](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetEndpoint (all fields
// optional at the wire level).
func (e *GetEndpointEntity) MatchTyped(match ...GetEndpoint) GetEndpoint {
	if len(match) > 0 {
		return typedFrom[GetEndpoint](e.Match(asMap(match[0])))
	}
	return typedFrom[GetEndpoint](e.Match())
}
...
func (e *GetEndpointEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetEndpointEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GetEndpointEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetEndpointListMatch and returns []GetEndpoint. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GetEndpointEntity) ListTyped(reqmatch GetEndpointListMatch, ctrl map[string]any) ([]GetEndpoint, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GetEndpoint](res), nil
}



func (e *GetEndpointEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetEndpointEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetEndpointEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetEndpointEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
