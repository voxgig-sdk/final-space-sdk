...
func (sdk *FinalSpaceSDK) OptionsMap() map[string]any {
...
func (sdk *FinalSpaceSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FinalSpaceSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FinalSpaceSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FinalSpaceSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FinalSpaceSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FinalSpaceSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FinalSpaceSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FinalSpaceSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FinalSpaceSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FinalSpaceSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
